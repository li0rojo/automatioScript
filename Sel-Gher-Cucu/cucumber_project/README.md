...
2. Add following snippet there:
        ...
        <datasource jndi-name="java:jboss/datasources/cucumber_projectDataSource" pool-name="cucumber_projectDataSource" enabled="true" use-java-context="true">
            <connection-url>jdbc:h2:~/cucumber_projectDatabase;AUTO_SERVER=TRUE</connection-url>
            <driver>h2</driver>
            <security>
...
2. Add following snippet there:
        ...
        <security-domain name="cucumber_projectSecurityDomain" cache-type="default">
            <authentication>
                <login-module code="Database" flag="required">
                    <module-option name="dsJndiName" value="java:jboss/datasources/cucumber_projectDataSource"/>
...
2. Add following snippet to log all messages from the application:
        ...
        <logger category="CucumberTest.cucumber_project">
            <level name="ALL"/>
        </logger>
